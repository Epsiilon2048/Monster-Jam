...
#macro win_width  ((os_type == os_operagx) ? browser_width : window_get_width())
#macro win_height ((os_type == os_operagx) ? browser_height : window_get_height())

#macro gui_width  ((os_type == os_operagx) ? browser_width : display_get_gui_width())
#macro gui_height ((os_type == os_operagx) ? browser_height : display_get_gui_height())
